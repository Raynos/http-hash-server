...
class HttpRequestContext {
    ...
    constructor(requestTime, parsedUrl, route) {
...
class Endpoint {
    ...
    constructor(serviceName, methodName, routeHandler) {
...
class HttpServiceRouter {
    hash: THttpHash;
    urlNotFound: (
        req: HttpRequest, res: HttpResponse, opts: null
    ) => void;
    methodNotAllowed: (
        req: HttpRequest, res: HttpResponse, opts: null
    ) => void;
    ...
    handleRequest(req: HttpRequest, res: HttpResponse, opts: null) {
