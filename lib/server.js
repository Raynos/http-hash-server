...
import type { HttpRequest, HttpResponse } from './_types.js';

export type Router = {
    handleRequest(req: HttpRequest, res: HttpResponse, opts: null): void;
}
...
class HttpHashServer {
    ...
    constructor(opts: ServerOptions) {
        ...
        assert(
            ...
            'Expected opts.port to be an integer >= 0 ' +
                'in HttpHashServer constructor'
        );
    ...
    _handleRequest(req: HttpRequest, res: HttpResponse) {
    ...
    listen(callback: Callback) {
        ...
        self._httpServer.listen(
            this.port, this.hostname, undefined, bindOnServerListening
        );
    ...
    _onServerDestroyed(callback: Callback) {
